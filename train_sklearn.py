...
depression_questions = [key for key in categories if categories[key] == "depression"]
anxiety_questions = [key for key in categories if categories[key] == "anxiety"]
stress_questions = [key for key in categories if categories[key] == "stress"]
...
for num_questions in question_numbers:
    ...
    for a in range(models_to_train):
        ...
        if "score" in target:
            ...
            labels = labels_df[[target + "_positive"]].copy()
